...
struct Config {
    ...
    // STEPH: changed padding (was 60), width (was 40), fontsize (was 40)
...
class BWCircularSlider: UIControl {
    ...
    override init(frame: CGRect) {
        ...
        // STEPH: changed this to make circle fit in frame. 3 instead of 2
        radius = self.frame.size.width/3 - Config.TB_SAFEAREA_PADDING
    ...
    override func drawRect(rect: CGRect){
        ...
        /** Draw the Background **/
        /* STEPH: commented out b/c didn't want shadow */
        ...
        */
        ...
        //STEPH: commented out didnt want blur
